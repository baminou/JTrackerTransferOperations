...
class ToStage(YmlConfigOperation):
    ...
    def _parser(self, main_parser):
        ...
        main_parser.add_argument('-t', '--filetype', dest='fileType', required=True)
    ...
    def _run(self):
        ...
        to_stage = ega_transfer.get_files_to_stage(list(set(audit_fids) - set(ega_box_fids + jtracker_fids)), self.args.audit, self.args.fileType)
